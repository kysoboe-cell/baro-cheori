...
export type Problem = {
  ...
  /**
   * 업체 선택 목록 위에 들어가는 개요 본문 2~3문단입니다(애드센스 개선
   * 지시서 4단계). lead·firstAid보다 한 단계 더 구체적인 내용 — 하위
   * 업체들의 실제 상세 페이지 내용에서만 뽑은 사실로 구성합니다.
   */
  overview?: string[];
  /** 관련 허브 slug */
  related?: string[];
...
export const problems: Problem[] = [
  {
    ...
    overview: [
      "카드 명세서에 찍힌 결제처 이름이 해지한 서비스와 다르게 보일 때가 있습니다. 넷플릭스는 카드 명세에 통신사·애플·구글로 찍힐 수 있다고 안내합니다. 유튜브 프리미엄은 해지한 계정과 지금 로그인한 계정이 같은지, 가족 계정·다른 구글 계정·애플 구독에 멤버십이 남았는지부터 보라고 안내합니다. 티빙도 카드 명세서의 결제 이름과 이용권 화면의 결제 유형을 맞춰보라고 안내하고, 웨이브·디즈니+는 결제처가 같은지 확인하라고 안내하며, 셋 다 Apple·Google·통신사 등 실제 결제처에 같은 구독이 남았는지 확인하라고 안내합니다.",
      "유튜브 프리미엄과 티빙은 해지 뒤에도 이용 기간이 끝날 때까지 화면이나 시청이 유지되는 것은 정상일 수 있으며, 다음 결제 날짜가 사라졌는지로 새로 결제된 것인지 구분하라고 안내합니다. 웨이브도 남은 기간 동안 재생되는 것은 정상일 수 있다고 안내하고, 디즈니+는 새 결제가 생겼는지를 기준으로 구분하라고 안내합니다. 쿠팡 와우는 해지 여부보다 이번 달 요금 환불이 관건이며, 결제 뒤 로켓배송·쿠팡플레이 같은 혜택을 이미 썼는지에 따라 환급 여부가 갈린다고 안내합니다.",
      "네이버플러스 멤버십은 네이버페이 결제내역에서 멤버십 기본요금인지 콘텐츠 추가요금인지 먼저 나눠보고, Npay 머니 자동충전은 결제가 아니라 잔액을 채운 내역일 수 있다고 구분합니다. 카드에 APPLE.COM/BILL이나 GOOGLE*앱 이름이 찍혔다면 Apple·Google Play 결제내역에서 같은 금액을 검색해 결제를 찾습니다. 본인·가족이 결제했다면 둘 다 환불을 요청하면 되지만, 아무도 결제하지 않았을 때는 절차가 다릅니다 — Google Play는 공식 화면에서 승인되지 않은 거래로 신고하고, Apple은 계정 암호를 바꾼 뒤 카드사에 모르는 결제로 신고합니다.",
    ],
...

  {
    ...
    overview: [
      "카드사 공식 앱에서 분실신고 메뉴를 먼저 찾고, 앱을 쓸 수 없을 때만 전화로 접수합니다. 잃어버린 카드를 선택하면 이용정지가 완료됐다는 화면이나 문자를 확인할 수 있고, 이어서 최근 결제내역을 열어 내가 쓰지 않은 결제가 있는지 살펴봅니다. 모르는 결제가 있으면 재발급 신청과는 별도로 부정사용 신고도 함께 접수합니다. 새 카드를 받을 주소를 확인하고 재발급을 신청하는 절차는 순서상 가장 마지막입니다.",
      "분실신고 접수처는 카드사마다 다릅니다. KB국민카드는 1588-1788, 신한카드는 1544-7200(신한 SOL페이로도 가능), 삼성카드는 1588-8900이며, 세 곳 모두 공식 앱의 분실신고 메뉴가 우선이고 전화는 앱을 쓸 수 없을 때 이용하는 예비 수단입니다. 카드를 다시 찾았더라도 신고 해제 여부를 확인하기 전에는 사용하지 마세요.",
    ],
...

  {
    ...
    overview: [
      "삼성전자서비스는 요금안내 페이지 안에서 탭 버튼으로 서비스요금 산정기준과 보증기간 산정기준을 오가며 볼 수 있고, 출장비는 평절기 28,000원·성수기 33,000원에 할증 5,000원이 붙는 정액 기준으로 공시돼 있습니다. LG전자는 [요금/보증] 페이지 한 곳에서 제품별 보증기간과 유상수리 조건을 함께 안내하며, 출장점검료도 같은 페이지에 정액 기준으로 나와 있습니다.",
      "보증기간 안에서도 유상이 되는 기준은 회사마다 항목명이 다릅니다. 삼성전자서비스는 '유상수리 대상'에 내 고장이 해당하는지, 또 '고장이 아닌 점검'인지를 따로 안내하고, 품목별 보증기간은 일반 1년·휴대폰 2년·계절성 2년으로 나눕니다. LG전자는 '유상수리 항목'에서 고장 원인의 해당 여부를 확인하며, 일반제품·계절제품·휴대전화의 보증기간 기준을 서로 다르게 둡니다.",
      "출장비가 청구되는 상황도 회사별 공시 내용이 다릅니다. 삼성전자서비스는 '보증기간과 무관하게 출장비가 청구되는 경우' 목록을 요금안내에 따로 공시해뒀고, 유상 안내 후 수리를 취소해도 출장비는 청구됩니다. LG전자는 고장이 아닌 단순 점검 요청도 기사가 방문하면 출장점검료가 발생할 수 있다고 안내합니다.",
    ],
...

  {
    ...
    overview: [
      "넷플릭스·티빙·웨이브·디즈니+·유튜브 프리미엄은 서비스 자체에서 직접 결제했을 수도, 애플·구글·통신사를 거쳐 가입했을 수도 있어 같은 서비스라도 사람마다 해지 화면이 다르게 보입니다. 티빙×웨이브처럼 묶여 있는 이용권은 처음 돈을 낸 쪽에서 해지해야 하고, 네이버플러스 멤버십은 다른 서비스와 달리 '다음 결제만 막는 해지'와 '지금 끝내고 환불받는 즉시 종료'가 아예 별도 메뉴로 나뉘어 있어 둘 중 원하는 쪽을 먼저 정해야 합니다.",
      "업체를 고르기 전에는 결제 영수증부터 확인하는 게 순서에 맞습니다. 아이폰이라면 이메일에서 'Apple 영수증'을 검색하거나 설정의 구독 목록을, 안드로이드라면 구글플레이의 정기 결제 목록을 먼저 열어 실제로 돈을 낸 곳이 어디인지 확인하면 어느 페이지를 봐야 할지 바로 정해집니다.",
      "헷갈리기 쉬운 함정은 해지 화면 마지막에 비슷하게 생긴 버튼 두 개가 나란히 있는 경우입니다. 쿠팡은 파란 큰 버튼이 '유지하기'라서 눌러도 해지가 안 되고 그 아래 흰색 '해지 신청 완료하기'를 눌러야 끝나며, 넷플릭스도 파란 버튼이 아니라 검은 버튼을 눌러야 진짜 해지입니다.",
    ],
...

  {
    ...
    overview: [
      "통신사마다 신고 화면과 메뉴 이름이 다릅니다. SKT는 T world의 MY에서 '분실/정지/해제' 메뉴를 열어 회선을 선택하면 분실신고와 이용정지를 함께 진행합니다. KT는 분실신고 페이지에서 로그인이나 본인인증을 거친 뒤 회선을 골라 분실신고와 필요한 일시정지를 진행합니다. LG유플러스는 분실 접수 페이지에서 [분실 등록]을 누르고 본인인증 후 회선 정보를 입력해 분실접수와 일시정지를 마칩니다.",
      "세 통신사 모두 분실신고만 하고 정지하지 않으면 요금이 계속 나갈 수 있다고 안내합니다. SKT는 월정액이나 일부 서비스 요금이, LG유플러스는 월정액·부가서비스·소액결제가 발생할 수 있다고 적혀 있고, KT도 분실신고와 이용정지를 함께 진행해야 한다고 안내합니다. 로그인이 안 될 때는 다른 전화로 SKT 1599-0011, KT 1588-0010, LG유플러스 080-019-7000으로 연락하면 되며, LG유플러스 상담은 24시간 가능합니다.",
      "휴대폰을 다시 찾았을 때 처리 방법도 다릅니다. SKT는 같은 메뉴에서 분실신고와 정지를 함께 해제하고, LG유플러스는 같은 페이지에서 분실접수 취소를 확인할 수 있습니다. KT는 같은 페이지에서 분실신고를 해제하는 절차가 안내되어 있습니다. 휴대폰이나 유심에 신용카드·학생증·공동인증서·T머니 같은 결제수단이 있었다면, 정지와 별개로 해당 기관에도 신고해야 합니다.",
    ],
    lastChecked: "2026-08-20",
  },

  {
    ...
    overview: [
      "조회 화면에 아무 정보도 없거나 '상품인수 전'으로 표시된 채 그대로면, 택배사가 아직 물건을 넘겨받지 않은 상태입니다. 이 단계에서는 택배사보다 판매자나 구매처에 실제로 발송했는지부터 물어보는 편이 맞습니다. 위치가 실제 배송지와 다른 지역명으로 찍히기도 하는데, 이는 택배 터미널을 거치는 경유지가 표시되는 것으로 최종 배송완료로 바뀌기 전까지는 나올 수 있는 표시입니다. 운송장 번호 전체와 주소·전화번호는 공개 게시판이나 댓글에 올리지 않는 편이 좋습니다.",
      "택배사마다 확인 방법에 차이가 있습니다. 롯데택배는 공식 배송조회에서 최근 3개월 이내 운송장 정보만 확인할 수 있고, 스마일박스(무인함)로 받는 상품이 안 보이면 알림 문자에 적힌 비밀번호로 확인하되 문자를 못 받았다면 판매자나 롯데택배 고객센터에 사물함 위치를 재확인 요청하면 됩니다. 한진택배는 반값택배 등 일부 상품이 편의점 픽업 방식이라 일반 방문배송과 조회·수령 방식이 다를 수 있습니다.",
    ],
    lastChecked: "2026-08-20",
  },

  {
    ...
    overview: [
      "쿠팡은 마이쿠팡 주문목록에서 [교환·반품 신청]을 눌러 사유를 입력하면 접수되고, 포장 겉면에 '쿠팡 반품'이라고 적어 평소 상품을 받던 문 앞에 두면 기사님이 회수합니다. 네이버 스마트스토어([반품요청]), G마켓([반품신청]), 11번가([반품신청])는 사유를 고르는 화면에서 방문수거 가능 여부도 함께 선택하고, 방문수거를 선택했을 때만 포장한 상품을 문 앞에 내놓습니다. 이 세 곳은 직접발송이나 편의점 반품을 선택한 경우 문 앞에 두지 말고 신청 화면에 나온 방법대로 보내야 합니다.",
      "네이버 스마트스토어·G마켓·11번가는 단순변심 반품이면 배송비를 구매자가 부담할 수 있고, 상품 불량·파손·오배송처럼 판매자 책임이면 부담 기준이 달라진다고 안내합니다. 쿠팡은 단순변심인지 상품 문제인지에 따라 반품 비용이 달라질 수 있으니 신청 화면에서 직접 확인하라고 안내합니다.",
      "네이버 스마트스토어는 입점 판매자마다 반품·교환 정책이 달라 상품 상세페이지의 반품 안내를 먼저 확인해야 하고, 판매자가 반품을 거절하면 네이버페이 고객센터에 분쟁 조정을 요청할 수 있습니다. G마켓은 스마일배송 상품을 G마켓이 직접 처리해 상대적으로 빠른 편이고, 일반 판매자 배송은 판매자 확인 절차가 추가됩니다. 11번가는 상품·판매자에 따라 지정 택배사가 다를 수 있고, 아마존 글로벌 상품(해외직구)은 반품 배송비와 소요기간이 국내 상품과 다르게 적용됩니다.",
    ],
    lastChecked: "2026-08-20",
  },

  {
    ...
    overview: [
      "SKT는 별도의 해지 신청 화면 대신 B world에 로그인해 인터넷·B tv 상품과 약정 종료일, 휴대폰·가족 결합 여부를 확인한 뒤 온라인 문의에 '오늘 해지할 때 내는 총금액과 결합 할인 변동을 알려주세요'라고 남기고 답변으로 금액을 받는 방식입니다. KT는 KT닷컴 마이 메뉴의 [홈상품 해지신청]에서, LG U+는 MY의 [서비스 해지]에서 해지할 상품을 고르면 최종 신청 전 화면에 예상 비용이 뜹니다.",
      "SKT 문의 답변에는 할인반환금·장비 미반납금·남은 요금이 나뉘어 나옵니다. KT 화면에는 예상 비용과 결합 할인 변동이 함께 표시되며, 금액이 보이지 않으면 100에 같은 내용을 물어볼 수 있습니다. LG U+ 화면에서 금액이 보이지 않으면 온라인 문의의 1:1 문의에 총금액과 결합 변동을 남기면 ARS를 거치지 않아도 됩니다.",
      "KT는 인터넷과 지니TV의 약정 종료일이 서로 다를 수 있다는 점을 따로 확인하도록 안내합니다. 장비 미반납금에 대해 KT는 장비를 정상 반납하면 내지 않는 항목인지 구분해서 보라고 안내하고, LG U+는 공유기나 셋톱박스를 정상 반납하면 내지 않는 항목인지 구분해서 보라고 안내합니다. SKT는 공식 요금표의 계산식이 참고용이며 가입일·상품·결합에 따라 실제 금액이 달라질 수 있다고 안내합니다.",
    ],
    lastChecked: "2026-08-20",
  },

  {
    ...
    overview: [
      "KB Pay, 신한 SOL페이, 삼성카드 앱 모두 재발급 절차는 같습니다. 앱에서 내 카드를 열고 재발급 또는 카드 관리 메뉴를 찾아 재발급 사유와 받을 주소를 확인한 뒤 신청을 완료합니다. 이 메뉴가 보이지 않거나 가족카드 같은 특수 카드라면, 그 단계에서 카드사 전화상담을 이용합니다.",
      "분실카드는 재발급을 신청했다고 해서 곧바로 정지되는 것이 아닙니다. 분실신고와 이용정지가 실제로 완료됐는지는 재발급 신청과는 별도로 확인해야 합니다.",
      "새 카드를 받은 뒤에는 사용등록을 하고, 자동이체나 정기결제에 등록해 둔 카드번호도 새 번호로 바꿔야 합니다. 분실로 인한 재발급은 보안상 카드번호가 바뀌는 경우가 일반적이기 때문입니다. 신청 후 실제로 카드를 손에 쥐기까지는 통상 며칠에서 1주 내외가 걸리며, 카드사와 배송지역에 따라 차이가 있습니다.",
    ],
    related: ["lost-card"],
    lastChecked: "2026-08-20",
  },

  {
    ...
    overview: [
      "화면에 뜬 오류 글자와 제품 뒷면(또는 옆면) 스티커에 있는 모델명을 사진으로 찍어두면, 삼성전자서비스는 제품 자가진단 메뉴에서 제품과 증상을 고른 뒤 그 오류 글자를 검색하도록 안내하고, LG전자는 고객지원 검색창에 모델명과 오류 글자를 함께 넣도록 안내합니다. 다만 불꽃·연기·타는 냄새가 난다면 자가진단을 시도하지 말고 바로 전원을 끄고 제품에서 떨어져야 합니다.",
      "공식 안내대로 점검해서 정상으로 돌아오면 수리 예약 자체를 하지 않아도 되고, 같은 문제가 계속되면 큰 가전은 출장수리로, 들고 갈 수 있는 제품은 센터 방문으로 넘어가는 순서입니다. 제품을 임의로 분해하면 다치거나 무상수리가 어려워질 수 있고, 휴대폰이나 PC는 수리를 맡기기 전에 사진과 중요한 파일을 다른 곳에 미리 옮겨 두어야 합니다.",
      "제품 자체의 고장이 아닐 때도 있습니다. 삼성전자서비스는 콘센트·인터넷·외부 연결기기 문제로 밝혀지면 방문 점검 비용이 생길 수 있다고 안내하고, LG전자는 차단기·콘센트·인터넷 같은 외부 문제는 제품을 수리해도 해결되지 않을 수 있다고 안내합니다.",
    ],
    related: ["repair-cost"],
    lastChecked: "2026-08-20",
  },
