...
export const googlePlay: Company = {
  ...
  overview: [
    "Play 스토어 프로필 사진 → 결제 및 정기 결제 → 정기 결제에서 앱을 골라 취소합니다. 앱을 삭제해도 구독은 취소되지 않고, 목록이 비어 있으면 다른 구글 계정을 확인합니다.",
    "이 취소는 다음 결제만 막을 뿐이라, 이미 빠진 돈은 Google Play 환불 화면에서 결제 계정으로 로그인해 주문과 사유를 골라 신청합니다.",
    "카드 명세서에 GOOGLE*앱 이름으로 찍힌 결제는 주문 내역에서 같은 금액을 찾아봅니다. 가족이 결제했다면 일반 환불을, 아무도 결제하지 않았다면 거래일로부터 120일 안에 승인되지 않은 거래로 신고합니다.",
  ],
