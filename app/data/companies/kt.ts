  ...
  services: [
    {
      ...
      quickSummary: [
        "전화하지 않아도 KT 홈페이지에서 휴대폰 분실신고를 할 수 있어요.",
        "휴대폰을 잃어버렸다면 가능한 빨리 분실신고와 정지 여부를 확인하세요.",
      ],
      ...
      steps: [
        "KT 공식 분실신고 페이지로 들어갑니다.",
        "본인 정보를 확인하고 로그인 또는 본인인증을 진행합니다.",
        "분실한 휴대폰을 확인합니다.",
        "화면 안내에 따라 분실신고를 진행합니다.",
        "휴대폰을 다시 찾았다면 같은 메뉴에서 분실신고 해제도 확인합니다.",
      ],
...

    {
      ...
      quickSummary: [
        "이사를 간다고 기존 인터넷을 먼저 해지하지 마세요.",
        "KT닷컴에서 새 주소와 원하는 설치 날짜를 입력해 설치장소 변경을 신청할 수 있어요.",
      ],
      ...
      steps: [
        "이사할 새 주소와 원하는 설치 날짜를 준비합니다.",
        "KT 설치장소 변경 페이지로 들어갑니다.",
        "변경할 주소를 입력합니다.",
        "설치 희망일시를 선택합니다.",
        "화면 안내에 따라 신청을 완료하고 방문 일정을 확인합니다.",
      ],

      tips: [
        "새 주소에서 KT 인터넷 설치가 가능한지 먼저 확인하는 것이 좋아요.",
...

    {
      ...
      quickSummary: [
        "고객센터에 전화하지 않아도 마이케이티 앱이나 KT닷컴에서 요금을 확인할 수 있어요.",
        "확인한 요금은 온라인에서 바로 납부할 수도 있어요.",
      ],

      steps: [
        "마이케이티 앱을 실행하고 로그인합니다.",
        "메뉴 → 마이 → 요금/서비스로 들어갑니다.",
        "요금조회에서 이번 달 요금이나 명세서를 확인합니다.",
        "바로 납부하려면 요금납부 → 즉시납부를 선택합니다.",
        "납부할 상품과 금액을 확인하고 본인인증 후 결제를 완료합니다.",
      ],
...

    {
      ...
      steps: [
        "먼저 휴대폰 문의인지 인터넷·TV·전화 문의인지 확인합니다.",
        "휴대폰 문의라면 KT 휴대폰에서 국번 없이 114로 전화합니다.",
        "인터넷·TV·전화 문의라면 국번 없이 100으로 전화합니다.",
        "ARS에서 필요한 업무를 선택합니다.",
      ],
      ...
      tips: [
        ...
        "전화하기 전에 분실신고·요금조회·납부·설치장소 변경처럼 온라인에서 직접 처리할 수 있는지 먼저 확인하는 것이 빠릅니다.",
      ],
