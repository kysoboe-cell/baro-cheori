...
export const gmarket: Company = {
  ...
  overview: [
    "주문취소는 나의 G마켓 주문내역의 [취소신청] 버튼에서, 반품·환불은 [반품신청] 버튼에서 시작됩니다. 발송 후에는 반품 신청으로 넘어가며, 반품 배송비는 단순변심이면 구매자 부담, 불량·오배송이면 기준이 다릅니다.",
    "주문내역 확인은 나의 G마켓 주문내역에서 주문상태·택배 위치를 봅니다. 배송 지연·미도착·반품 회수 안 됨도 상태를 살핀 뒤 [문의하기]로 이어집니다. G마켓과 옥션은 주문관리가 따로입니다.",
    "판매자 문제는 판매자 문의로, G마켓 처리가 필요하면 1566-5701에서 주문·배송 1번, 반품·교환 2번을 누릅니다.",
  ],
