          ...
          {categories.map((category) => {
            ...
            return (
              <button
                ...
                className={`flex min-w-0 items-center justify-center gap-1 rounded-xl border px-1 py-2.5 text-left text-[11px] font-bold transition sm:justify-between sm:gap-2 sm:px-3 sm:text-sm ${
                  isActive
