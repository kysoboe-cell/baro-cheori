...
카드 분실·모르는 결제, 구독 해지·환불, 쇼핑몰 배송·반품, 통신사 휴대폰 분실·인터넷, 택배 문제를 지금 누를 공식 메뉴부터 안 될 때 연락처까지 한 화면에 정리하는 Next.js 서비스입니다.

- 공개 주소: https://baro-cheori.netlify.app
- 기술: Next.js 16.3.1, TypeScript, Tailwind CSS 4
- 현재 범위: 쇼핑몰 4곳, 통신사 3곳, 택배사 3곳, 카드사 3곳, 구독서비스 3곳, 주요 업무 77개
